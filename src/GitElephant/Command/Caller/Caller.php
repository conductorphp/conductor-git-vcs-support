...
namespace ConductorGitVcsSupport\GitElephant\Command\Caller;
 ...
 * Caller
 *
 * @todo Remove this class once https://github.com/matteosister/GitElephant/pull/147 is merged
...
class Caller implements CallerInterface
{
     ...
     * Class constructor
     *
     * @param GitBinary $binary         the binary
